      ...
      <div className="flex flex-1 overflow-hidden relative"> 
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <button className="hidden md:inline-block text-slate-400 hover:text-slate-100 p-1">{HAMBURGER_ICON}</button>
          </div>
          <div className="flex space-x-2">
            ...
            <button className="flex-1 flex items-center justify-center text-sm bg-slate-700 hover:bg-slate-600 py-2 px-3 rounded-md">{COMPASS_ICON} Discover</button>
          </div>
          <div>
        ...
        >
            ...
            <div className="border border-slate-700 rounded-lg p-3">
                <div className="flex justify-between items-center mb-2">
                    ...
                    <span role="img" aria-label="Podcast" className="text-xl">🎙️</span>
                </div>
              ...
              <div className="flex-1 flex flex-col min-h-0"> 
                ...
                <audio ref={audioPlayerRef} className="w-full h-10 rounded-md bg-slate-700 overflow-hidden" controls style={{ display: 'none' }}>
                  {podcastSegments.map((segment) => (
                    <source key={segment.id} src={segment.audioUrl || ''} type="audio/mpeg" />
                  ))}
